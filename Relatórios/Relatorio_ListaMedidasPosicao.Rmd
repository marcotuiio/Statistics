---
title: "Relatório - Lista Medidas de Posição" 
...
quantil = function(Li, Fq, Fac, a, i, n) {
    # i = porcento do quantil desejado    
...
```
## Item a) Agrupar os dados em classes e calcular a média, moda e a mediana;
```{r}
...
```
## Item b) Determine, sem agrupar em classes (dados brutos): a média, moda e mediana
```{r}
...
# Ex 2:
```{r}
leitos = sort(c(48, 53, 58, 62, 64, 66, 69, 71, 77, 81,
           49, 54, 58, 62, 64, 67, 69, 72, 77, 82,
           50, 55, 59, 63, 65, 67, 70, 73, 78, 83,
           52, 56, 60, 64, 65, 67, 70, 74, 78, 86,
           52, 57, 61, 64, 66, 68, 71, 76, 80, 90))
```
## Item a) Determine a média e mediana dos dados e, também, determine o terceiro quartil e interprete-o; 

```{r}
media = MEDIA(leitos); media
mediana = leitos[25]; mediana
moda = 64;
q3 = quantil(72, 12, 24, 6, 0.75, 50); q3
...
## Item b) Construa o gráfico de caixas (box plot).
```{r}
boxplot(leitos);
```


## Item c) Agrupar os dados em classes (sqrt(n)) e calcular a média, moda e a mediana.
```{r}
...
quarto_decil = quantil(9, 12, 8, 5, 0.4, sum(fi)); quarto_decil # 40%
primeiro_quartil = quantil(9, 12, 8, 5, 0.25, sum(fi)); primeiro_quartil # 25%
septuagesimo_segundo_percentil = quantil(14, 17, 20, 5, 0.72, sum(fi)); septuagesimo_segundo_percentil # 72%
```
